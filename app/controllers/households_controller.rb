class HouseholdsController < ApplicationController
  ...
  # GET /households/1
  def show
    # show the user details in the household. Results should be a JSON object which has household
#     household: {
#       id: 1
#       users: [{}, {}]
#     }
# landlord with house id = house_id
# Users in the household_id = household_id
