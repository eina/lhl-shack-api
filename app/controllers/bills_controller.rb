class BillsController < ApplicationController
  ...
  def index 
    ...
    if params.values_at(:household_id, :bill_uuid, :user_id).all?(&:present?)      
      ...
      @bills = Bill.filter_unpaid_bill_due_soon(params)      
  ...
  def bill_params
    params.require(:bill).permit(:total_amount, :due_date, :name, :interval, :user_amount, :household_id, :user_id, :bill_uuid, :user_status, :bill_status)
  end
end
